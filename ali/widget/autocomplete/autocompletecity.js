/**
 * @desc autocomplete 这个主要是在city.html中的进入城市按钮的使用
 * @copyright (c) 2013 273 Inc
 * @author zhuangjx.273.cn
 * @since 2013-10-15
 */
...
module.exports = function () {
    ...
    var W = (function() {
        ...
        function j() {
            ...
            for (var t = 0, u = C.length; t < u; t++) {
                ...
                q.innerHTML = Y(m, '<dl><dt>'+C[t][0]+'</dt>');
            }
            h.innerHTML = "";
            h.appendChild(l);
            X();
    ...
    var T = (function() {
        ...
        function G(e) {
            ...
            if (I("bdsug_ipt_sug")) {
                if (I("bdsug_ipt_sug").value == S(I("autocity").value)) {
                    L({
                        n: 1,
                        sug: 1
                    })
    ...
    var Q = (function() {
        ...
        function G(Y) {
            ...
            C = K("SCRIPT");
            C.src = "http://data.273.cn/?_mod=AutoCity&auto_city="+ encodeURIComponent(I("autocity").value);
            C.charset = "utf-8";
