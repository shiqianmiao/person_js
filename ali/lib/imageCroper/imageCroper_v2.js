...
ImageCroper.init = function (config) {
    ...
    $('body').prepend('' +
        '<object style="position: absolute; top: -10000px; left: -10000px" id="__ImageCroper__SWF_CONTAINER" type="application/x-shockwave-flash" data="' + flash_url + '" width="1" height="1">' +
