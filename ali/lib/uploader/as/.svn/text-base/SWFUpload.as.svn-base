package {
    ...
    public class SWFUpload extends Sprite {
        ...
        private const build_number:String = "2013-07-24";
        ...
        * *************************************** */
        ...
        private function Select_Handler(file_reference_list:Array):void {
            ...
            this.Debug(successful_uploads.toString());
            this.Debug(queued_uploads.toString());
            this.Debug(queue_slots_remaining.toString());
        ...
        ****************************************************************** */
        ...
        private function SelectFile():void  {
            ...
            this.Debug("Event: fileDialogStart : Browsing files. Single Select. Allowed file types: " + this.fileTypes);
            ExternalCall.Simple(this.fileDialogStart_Callback);

            try {
                this.fileBrowserOne.browse([new FileFilter(this.fileTypesDescription, this.fileTypes)]);
            } catch (ex:Error) {
        ...
        private function SelectFiles():void {
            ...
            this.Debug("Event: fileDialogStart : Browsing files. Multi Select. Allowed file types: " + this.fileTypes);
            ExternalCall.Simple(this.fileDialogStart_Callback);

            try {
                this.fileBrowserMany.browse([new FileFilter(this.fileTypesDescription, this.fileTypes)]);
            } catch (ex:Error) {
                this.Debug("Exception: " + ex.toString());
            }
        }
        ...
        *************************************************************** */
        ...
        private function PrepareResizedImage(resizeSettings:Object, current_file_item:FileItem):void {
            try {
                ...
                this.Debug("Settings: Width: " + resizeSettings["width"] + ", Height: " + resizeSettings["height"] + ",  Quality: " + resizeSettings["quality"] + ".");
        ...
        private function PrepareResizedImageCompleteHandler(event:ImageResizerEvent, current_file_item:FileItem):void {
            ...
            this.Debug("status: " + current_file_item.file_status.toString());
            if (current_file_item != null && current_file_item.file_status != FileItem.FILE_STATUS_CANCELLED) {
